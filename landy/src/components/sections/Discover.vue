    ...
    <div class="relative z-10 w-full max-w-screen-2xl mx-auto px-6 sm:px-10 md:px-16 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-32 items-center h-[80vh]">
      ...
      <div class="relative w-full h-[45vh] lg:h-[70vh] overflow-hidden flex items-center justify-center filter drop-shadow-2xl brightness-90">
        ...
        <div class="slide-img absolute inset-0 w-full h-full">
          <img :src="car30" alt="Design Premium" width="1000" height="800" loading="lazy" decoding="async" class="js-img w-full h-full object-contain">
        </div>
        
        <!-- Image 2 -->
        <div class="slide-img absolute inset-0 w-full h-full">
          <img :src="car45" alt="Ingénierie Moteur" width="1000" height="800" loading="lazy" decoding="async" class="js-img w-full h-full object-contain">
        </div>
        
        <!-- Image 3 -->
        <div class="slide-img absolute inset-0 w-full h-full">
          <img :src="car42" alt="Sensation Vitesse" width="1000" height="800" loading="lazy" decoding="async" class="js-img w-full h-full object-contain">
        </div>
